...
For the `rgs3` package to work successfully, the [GS3](http://snp.toulouse.inra.fr/~alegarra/) program should be already installed.
...
We can also have a quick look at the additive genetic relationships:
